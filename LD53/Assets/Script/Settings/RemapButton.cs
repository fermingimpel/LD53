...
public class RemapButton : MonoBehaviour
{
    ...
    protected void OnEnable()
    {
        if (s_RebindActionUIs == null)
            s_RebindActionUIs = new List<RemapButton>();
    ...
    private static List<RemapButton> s_RebindActionUIs;
    ...
    [Serializable]
    public class UpdateBindingUIEvent : UnityEvent<RemapButton, string, string, string>
    {
    }

    [Serializable]
    public class InteractiveRebindEvent : UnityEvent<RemapButton, InputActionRebindingExtensions.RebindingOperation>
    {
    }
}